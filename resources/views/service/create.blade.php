    ...
    <div class="container-fluid">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <form action="{{ route('enregistrer-service')}}" method="post">
                        <div class="box-body">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input  type="text" class="form-control" name="nom_service" placeholder="nom du service">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input  type="number" class="form-control" name="salaire" placeholder="Salaire">
